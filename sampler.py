...
from diffusion_utils import Trainer, VarTSampler
...
if __name__ == "__main__":
    ...
    parser.add_argument('--sampling_steps', type=list, default = [25,50,100,125,150,175,200], help='Step sizes for sampling')
